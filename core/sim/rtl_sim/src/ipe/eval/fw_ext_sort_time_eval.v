...
initial
   begin
      ...
      @(r0==16'h3800)
      start1 <= counter;
      wait(inst_fw==16'h246D)
      end1start2 <= counter;
      wait(inst_fw==16'h2430)
      end2start3 <= counter;
      wait(inst_fw==16'h921F)
      wait(inst_fw==16'h403B)
      end3start4 <= counter;
      ...
      $display("Latency of sorting (%d cycles)!", end3start4 - end2start3);
      $display("Latency of overlap checking (%d cycles)!", end4start5 - end3start4);
      $display("Latency of evaluating structs (%d cycles)!", end6 - end4start5);
