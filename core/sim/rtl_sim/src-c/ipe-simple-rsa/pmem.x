...
MEMORY
{
  data      (rwx)   : ORIGIN = 4096,  LENGTH = 10240
  bootcode  (rwx)   : ORIGIN = 14336, LENGTH = 1024
  bootcode_ivt (rw) : ORIGIN = 15324, LENGTH = 0x20
  fw_trampoline (rwx) : ORIGIN = 15356, LENGTH = 0x4
  text      (rx)    : ORIGIN = 23552, LENGTH = 41984
